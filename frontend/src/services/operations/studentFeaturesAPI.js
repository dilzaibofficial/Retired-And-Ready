...
export async function buyCourse(
  ...
  try {
    ...
    const stripe = await loadStripe(
      "pk_test_51Q90mr2LewuTEXoETZLxzjFCEMKSTkSPYtk2Fjjx4vvlwVbAVXbisDW0iUj1sIREf0gmIx25rIwAPzXpl1TeVj9B00AIEutf4J"
    );
    ...
    const result = stripe.redirectToCheckout({
      sessionId: orderResponse.data.message.id,
    });
